<?php
    /**
     * The base configuration for this project.
     * 
    ...
    /* Start session if session status is none */
     ...
     * - Library, third party files used for the project.
     */
    ...
    /* Absolute Base Path. Do not change. */
    if ( !defined('PATH') ) {
